...
class EEPSystem extends React.Component {
  ...
  render() {
    const { classes, theme, backendURL } = this.props;
    ...
    const drawer = (
      <div>
        ...
        <ListItem
          button
          onClick={() => this.setState({ section: OrdersSection })}
        >
          <ListItemIcon>
            <OrdersIcon />
          </ListItemIcon>
        ...
        <ListItem
          button
          onClick={() => this.setState({ section: InventorySection })}
        >
          <ListItemIcon>
            <InventoryIcon />
          </ListItemIcon>
        ...
        <ListItem
          button
          onClick={() => this.setState({ section: ShippingSection })}
        >
          <ListItemIcon>
            <ShippingIcon />
          </ListItemIcon>
        ...
        <ListItem
          button
          onClick={() => this.setState({ section: SessionsSection })}
        >
          <ListItemIcon>
            <LockIcon />
          </ListItemIcon>
    ...
    switch (this.state.section) {
      case InventorySection:
        selectedSession = <Inventory backendURL={backendURL} />;
        break;
      case OrdersSection:
        selectedSession = <Orders backendURL={backendURL} />;
        break;
    ...
    const auth = (
      <div className={classes.login}>
        <Card className={classes.card}>
          <CardHeader title="EEP-Leaf Tech System" />
          <CardContent>
            <GoogleLogin
